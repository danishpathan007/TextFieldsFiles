...
public class AEOTPTextField: UITextField {
    ...
    public var otpBackgroundColor: UIColor = UIColor.appColor(.otpTFBg) //UIColor(red: 0.949, green: 0.949, blue: 0.949, alpha: 1)
    public var otpFilledBackgroundColor: UIColor = UIColor.appColor(.otpTFBg)//UIColor(red: 0.949, green: 0.949, blue: 0.949, alpha: 1)
    public var otpCornerRaduis: CGFloat = 30
